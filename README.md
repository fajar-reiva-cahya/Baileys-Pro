...
<div align="center"><img src="https://files.catbox.moe/ye5dkb.jpeg"></div>
...
```json
"dependencies": {
    "@whiskeysockets/baileys": "github:fajar-reiva-cahya/Baileys-Pro"
}
```
or install in terminal:
```
npm install @whiskeysockets/baileys@github:fajar-reiva-cahya/Baileys-Pro
```
